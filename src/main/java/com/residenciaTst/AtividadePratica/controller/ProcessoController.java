...
public class ProcessoController {
    ...
    public ResponseEntity<Processo> salvar(@RequestBody @Valid ProcessoDto processoDto){
        ...
        processoDto.getParteDoProcessoDTO().stream().forEach( parteDoProcessoDTO -> {
            ParteDoProcesso parteDoProcesso = ParteDoProcesso.builder().build();
            BeanUtils.copyProperties(parteDoProcessoDTO, parteDoProcesso);
            if(processo.getPartes() == null) processo.setPartes( new HashSet<>() );
            processo.getPartes().add(parteDoProcesso);
        });
